////////////////////////////////////////////////////////////////////
//DeRap: ProjetosBR_HumanZombie\config.bin
//Produced from mikero's Dos Tools Dll version 8.71
//https://mikero.bytex.digital/Downloads
//'now' is Sat Oct 08 12:47:19 2022 : 'file' last modified on Thu Jan 01 00:00:01 1970
////////////////////////////////////////////////////////////////////
...
class CfgMods
{
	class ProjetosBR_HumanZombie
	{
		...
		class defs
		{
			...
			{
				value = "";
				files[] = {"ProjetosBR_HumanZombie/scripts/3_Game"};
			};
			class worldScriptModule
			{
				value = "";
				files[] = {"ProjetosBR_HumanZombie/scripts/4_World"};
			};
			class missionScriptModule
			{
				value = "";
				files[] = {"ProjetosBR_HumanZombie/scripts/5_Mission"};
			};
		};
	};
};
class CfgPatches
{
	class ProjetosBR_HumanZombie
	{
		...
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"DZ_Characters","DZ_Characters_Zombies","DZ_Characters_Backpacks","DZ_Characters_Pants","DZ_Characters_Tops","DZ_Gear_Containers","DZ_Characters_Headgear","DZ_Gear_Camping","DZ_Gear_Crafting","DZ_Gear_Cooking","DZ_Gear_Tools","DZ_Animals","DZ_Data","DZ_Characters_Shoes","DZ_Characters_Gloves"};
	};
};
class cfgWeapons
{
